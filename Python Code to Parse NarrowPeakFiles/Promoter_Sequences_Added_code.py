def insert_column():
    ...
    If the 5' UTR is on the positive strand, then the promoter sequence is +-1000 bp upstream from start nucleotide.
    If the 5' UTR is on the negative strand, then the promoter sequence is +-1000 bp downstream from start nucleotide.

    """
    five_prime_only_file = open("C:\\Users\\Tanaya\\OneDrive - University of Toronto\\BCB330Y\\5' UTR_extracted.txt", "r")
    updated_column_file = open("C:\\Users\\Tanaya\\OneDrive - University of Toronto\\BCB330Y\\5' UTR_extracted_additional_column_revised.txt", "w")
